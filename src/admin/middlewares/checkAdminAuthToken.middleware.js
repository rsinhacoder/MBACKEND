...
exports.checkAdminAuthToken = void 0;
var common_1 = require("@nestjs/common");
require("dotenv").config({ debug: false });
var checkAdminAuthToken = /** @class */ (function () {
    function checkAdminAuthToken(jwtService) {
        this.jwtService = jwtService;
    }
    checkAdminAuthToken.prototype.use = function (req, res, next) {
        common_1.Logger.log(" Middleware: checkAdminAuthToken!");
        ...
        try {
            ...
            return res.status(400).json({
                code: "400",
                status: "error",
                message: "Error Occured in Admin Auth token",
                data: null
            });
        }
    };
    checkAdminAuthToken = __decorate([
        (0, common_1.Injectable)()
    ], checkAdminAuthToken);
    return checkAdminAuthToken;
}());
exports.checkAdminAuthToken = checkAdminAuthToken;
