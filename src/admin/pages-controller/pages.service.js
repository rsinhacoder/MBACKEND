...
var PageService = /** @class */ (function () {
    function PageService(pagesRepository) {
        this.pagesRepository = pagesRepository;
    }
    PageService.prototype.create = function (createPageDto) {
        return __awaiter(this, void 0, void 0, function () {
            var new_page, req_data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        new_page = this.pagesRepository.create(createPageDto);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.pagesRepository.save(new_page)];
                    case 2:
                        _a.sent();
    ...
    PageService.prototype.update = function (updatePageDto, pagetitle_id) {
        return __awaiter(this, void 0, void 0, function () {
            var pagetitle_id_, page, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        pagetitle_id_ = parseInt(pagetitle_id);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.pagesRepository.save(page)];
                    case 2:
                        _a.sent();
